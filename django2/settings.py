...
SECRET_KEY = 'django-insecure-f*bz0fbsv4l-tgvgc4^3iad2b@l9b)$(v(n$1houb^zt@g(9l0'
...
# Precisa ser contratado ou configurar na mao mesmo no Heroku

# Faz uma simulação de envio de email e print no console
# Só para teste
...
# Quando voce tem servidor de email, usar esse
# Para produção
